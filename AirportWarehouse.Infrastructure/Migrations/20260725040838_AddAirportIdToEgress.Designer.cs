...
namespace AirportWarehouse.Infrastructure.Migrations
{
    ...
    [Migration("20260725040838_AddAirportIdToEgress")]
    partial class AddAirportIdToEgress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirportWarehouse.Core.Entites.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AirportWarehouse.Core.Entites.Product", b =>
                {
                    ...
                    b.HasOne("AirportWarehouse.Core.Entites.Category", "Category")
                        .WithMany("Products")
